...
import TaxonomyReview from '../components/TaxonomyReview.vue';
...
const routes = [
  ...
  { path: '/admin/taxonomy', name: 'taxonomy-review', component: TaxonomyReview, meta: { label: 'Taxonomy Review', requiresAuth: true, requiresAdmin: true } },
];
