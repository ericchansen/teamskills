...
export const skillCategories = {
  ...
  'Data Platform': ['Azure Arc','Cache for Redis','Managed Redis','Analysis Services','Power BI Embedded','Power BI','Event Hubs','Log Analytics Workspace','Synapse Analytics Serverless','Synapse Analytics Dedicated Pools','Azure Data Factory'],
  'Fabric': ['Fabric OneLake','Cosmos DB on Fabric','Fabric Data Engineering and Data Science','Fabric Data Factory','Fabric Data Warehouse','Fabric Admin, governance, and security','Fabric Purview integration','Fabric Real Time Intelligence','Fabric IQ','SQL DB on Fabric','Fabric Capacity Management'],
